...
public class Nodes {
    ...
    public Nodes(android.view.SurfaceView surfaceView) {
        ...
        neuronBox[4] = new NeuronBox(5,neuronSprite, 2 * 14, 64, 62, 15, nandIronProcCover, 600, 400);
        ...
        neuronBox[5] = new NeuronBox(4,neuronSprite, 2 * 14, 64, 62, 10, nandIronProcCover, 350, 400);
    }
